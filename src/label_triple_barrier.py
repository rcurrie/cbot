...
def apply_triple_barrier(
    ...
    Returns:
        Tuple of (labels, barrier_touch_bars):
            ...
            - barrier_touch_bars: Number of bars until barrier touched, NaN where not computable.
...
def calculate_sample_weights(
    ...
    Args:
        barrier_touch_bars: Array indicating how many bars until barrier touched for each sample.
...
def label_triple_barrier(
    ...
    # Verify label distribution in final output
    ...
    # Verify sample weight distribution
...
@click.option(
    ...
    default=Path("data/labeled_log_fracdiff_price.parquet"),
