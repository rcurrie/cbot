...
Wrangle raw swap data downloaded from google big query into a series of WETH priced swaps with volume and information useful to develop a graph neural network in later phases.
